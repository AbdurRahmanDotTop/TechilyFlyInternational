...
import { a as jobs, d as eq, i as employers, t as getDb } from "./db_BmW1G98j.mjs";
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					})] }), isClosed ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
						size: "lg",
						variant: "secondary",
...
var $$Slug = createComponent(async ($$result, $$props, $$slots) => {
	...
	const jobData = await getDb(env).select({
		job: jobs,
		employer: employers
	}).from(jobs).leftJoin(employers, eq(jobs.employerId, employers.id)).where(eq(jobs.slug, slug)).get();
	if (!jobData) return Astro.redirect("/404");
	const formattedJob = {
		id: jobData.job.id,
