...
import { A as renderHead, B as createAstro, O as renderTemplate, T as renderSlot, j as addAttribute } from "./sequence_Cy34-R2h.mjs";
...
var $$Layout = createComponent(($$result, $$props, $$slots) => {
	...
	Astro.self = $$Layout;
	const { title = "Techily Fly International", description = "Find Your Next Career in the Gulf" } = Astro.props;
