...
var S = (0, import_react.forwardRef)((e, l) => {
	...
	let K = u?.id || `cf-turnstile-script`, q = _(K), J = u?.onLoadCallbackName || `onloadTurnstileCallback`, Y = (0, import_react.useMemo)(() => ({
		...
		M ? T : null,
		M ? E : null
	]), X = (0, import_react.useCallback)(() => typeof window < `u` && !!window.turnstile, []), Z = (0, import_react.useCallback)((e, t) => {
		try {
			return window.turnstile.render(e, t);
		} catch (e) {
			let t = M ? S : G.current.onError;
			t ? t(e instanceof Error ? e.message : String(e)) : console.error(e);
			return;
		}
	}, [M, M ? S : null]);
