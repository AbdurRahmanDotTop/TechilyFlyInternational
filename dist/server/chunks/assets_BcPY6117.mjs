...
import { Dt as AstroError, F as shorthash, Ft as ExpectedImageOptions, Gt as LocalImageUsedWrongly, Ht as IncompatibleDescriptorOptions, It as ExpectedNotESMImage, Lt as FailedToFetchRemoteImageDimensions, Pt as ExpectedImage, Qt as NoImageMetadata, Wt as InvalidImageService, Zt as MissingImageDimension, bt as removeQueryString, cn as UnsupportedImageFormat, gt as joinPaths, ht as isRemotePath, sn as UnsupportedImageConversion, tn as RemoteImageNotAllowed } from "./sequence_Cy34-R2h.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./image-service-workerd_BSeS9tp4.mjs").catch((e) => {
