...
import { a as useRenderElement, c as formatErrorMessage, d as useRefWithInit, f as SafeReact, i as cn, l as useIsoLayoutEffect, n as createLucideIcon, o as EMPTY_OBJECT, p as isElement, r as Button, s as NOOP, t as CircleCheck, u as useStableCallback } from "./circle-check_BoEzJB_r.mjs";
...
function Home() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
			className: "bg-gradient-to-br from-teal-900 via-teal-800 to-slate-900 text-white py-24 px-4",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-xl md:text-2xl text-teal-100 mb-10 max-w-3xl mx-auto",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Search, { className: "absolute left-3 top-3 h-5 w-5 text-gray-400" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
									placeholder: "Job title, keyword, or company",
									className: "pl-10 h-12 text-lg border-0 focus-visible:ring-0 text-black"
								})]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "hidden md:block w-px bg-gray-200 my-2" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "relative flex-1",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MapPin, { className: "absolute left-3 top-3 h-5 w-5 text-gray-400" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
								size: "lg",
								className: "h-12 px-8 bg-teal-600 hover:bg-teal-700 text-lg",
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
				...
				children: [
					...
					className: "block",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "bg-white p-6 rounded-xl border shadow-sm hover:shadow-md transition-shadow flex flex-col md:flex-row justify-between items-start md:items-center gap-4 group",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									...
									className: "ml-1.5 flex items-center text-blue-600",
									title: "Verified Employer",
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, { className: "h-4 w-4 fill-blue-600 text-white" })
								})]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							variant: "outline",
							className: "shrink-0 group-hover:bg-teal-50 group-hover:text-teal-700 group-hover:border-teal-200",
